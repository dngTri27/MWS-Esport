  ...
  <nav class="navbar navbar-expand-sm bg-black">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="profile.php" style="color: aliceblue;"><span><img src="images/login.png" alt="login icon" style="width: 40px;"></span> Profile</a></li>
      </ul>
    </div>
  </nav>
  <header class="showPage">
    <h1>MWS E-sport</h1>
    <p>Passion into each button pressed</p>
  </header>
  ...
  <section id="section-2">
    ...
    <div class="flex-columns">
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
        ...
        expedita ea illum nisi libero!</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          Ipsum voluptate laborum exercitationem delectus perspiciatis
          nemo unde fuga alias, porro similique distinctio adipisci sint
          quisquam atque culpa eum ipsa assumenda, quidem, odit officiis
          expedita ea illum nisi libero!
            Ipsum voluptate laborum exercitationem delectus perspiciatis
            nemo unde fuga alias, porro similique distinctio adipisci sint
            quisquam atque culpa eum ipsa assumenda, quidem, odit officiis
            expedita ea illum nisi libero!</p>
